...
// NTT核函数声明
__global__ void ntt_forward_kernel_basic(u32 *a_mont, u32 n, u32 p,
                                         u32 *twiddle_factors, int mid_level);

__global__ void ntt_forward_kernel_optimized(u32 *a_mont, u32 n, u32 p,
                                             u32 *twiddle_factors,
                                             int mid_level);

__global__ void ntt_inverse_kernel_basic(u32 *a_mont, u32 n, u32 p,
                                         u32 *twiddle_factors, int mid_level);

__global__ void ntt_inverse_kernel_optimized(u32 *a_mont, u32 n, u32 p,
                                             u32 *twiddle_factors,
                                             int mid_level);

__global__ void pointwise_multiply_kernel(u32 *a_mont, u32 *b_mont,
                                          u32 *ab_mont, u32 n, u32 mod,
                                          u32 neg_r_inv);

// GPU版本的多项式乘法函数
void poly_multiply_ntt_gpu_basic(u32 *a, u32 *b, u32 *ab, u32 n, u32 p,
                                 u32 omega = 3);
...
void copy_to_gpu_and_expand(u32 *host_data, u32 **gpu_data, u32 n,
                            u32 n_expanded);

void copy_from_gpu_and_shrink(u32 *gpu_data, u32 *host_data, u32 n_expanded,
                              u32 n);

// 辅助函数
void precompute_twiddle_factors_gpu(u32 **twiddle_factors_gpu, u32 n, u32 p,
                                    u32 omega_mont, bool is_inverse = false);
