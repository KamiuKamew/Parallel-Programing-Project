 ...
 * @param p 模数（质数）
 */
void poly_multiply_ntt_cuda_simple(u64 *a, u64 *b, u64 *ab, u64 n, u64 p, u64 OMEGA = 3);
 ...
 * @param p 模数（质数）
 */
void poly_multiply_ntt_cuda_serial(u64 *a, u64 *b, u64 *ab, u64 n, u64 p, u64 OMEGA = 3);
 ...
 * @param p 模数（质数）
 */
void poly_multiply_ntt_cuda_parallel_ready(u64 *a, u64 *b, u64 *ab, u64 n, u64 p, u64 OMEGA = 3);
 ...
 * @param p 模数（质数）
 */
void poly_multiply_ntt_cuda_parallel(u64 *a, u64 *b, u64 *ab, u64 n, u64 p, u64 OMEGA = 3);
...
template <typename T>
__global__ void pointwise_mul_kernel(T *a_mont, T *b_mont, T *ab_mont, T n, T p);
