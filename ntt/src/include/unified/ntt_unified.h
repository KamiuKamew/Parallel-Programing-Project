 ...
 */
inline void ntt_forward_unified(u32 *a, u32 n, u32 p, u32 omega_domain, u32 w_domain, ModBase *mod_impl)
{
 ...
 * @param mod_impl 模运算实现
 */
inline void ntt_inverse_unified(u32 *a, u32 n, u32 p, u32 omega_domain, u32 w_domain, ModBase *mod_impl)
{
 ...
 * @param mod_impl 模运算实现
 */
inline void poly_multiply_unified(u32 *a, u32 *b, u32 *ab, u32 n, u32 p, u32 omega, ModBase *mod_impl)
{
    // 扩展到2*n-1的下一个2的幂
    ...
    // 前向NTT
    ntt_forward_unified(a_expanded, n_expanded, p, omega_domain, w_domain, mod_impl);
    ntt_forward_unified(b_expanded, n_expanded, p, omega_domain, w_domain, mod_impl);
    ...
    // 逆向NTT
    ntt_inverse_unified(a_expanded, n_expanded, p, omega_domain, w_domain, mod_impl);
